	...
	return <div>
		<div className="relative mt-10 md:mt-[80px]">
			...
			<div className="absolute bottom-0 w-full py-4 pl-4 rounded-b-lg md:py-10 md:pl-10 bg-custom-black/50">
				<button onClick={ handleDonation } className="px-4 py-2 text-base font-semibold text-white border rounded md:text-xl md:px-6 md:py-4 border-custom-red hover:bg-transparent hover:text-custom-red bg-custom-red">Donate ${ price }</button>
			</div>
		</div>
